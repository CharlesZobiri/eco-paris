...
<template>
  <header>
    <div
      class="flex flex-col gap-8 text-center items-center justify-center h-screen bg-gradient-to-br from-green-50 to-green-100 p-12"
    >
      ...
      <div class="flex text-xl text-center gap-4 text-white mt-2">
        <button
          @click="goToHome"
          class="flex gap-2 justify-center items-center text-center bg-green-500 min-w-56 rounded-full"
        >
          <LayoutDashboard />Tableau de bord
        </button>
        <button
          @click="goToApi"
          class="flex gap-2 justify-center items-center text-center bg-green-800 border-green-500 min-w-56"
        >
